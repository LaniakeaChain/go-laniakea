...
func (db *Database) ReadAncients(fn func(op lkeadb.AncientReaderOp) error) (err error) {
	return fn(db)
}
...
func (db *Database) ModifyAncients(f func(lkeadb.AncientWriteOp) error) (int64, error) {
	panic("not supported")
}
...
func (db *Database) NewBatch() lkeadb.Batch {
	panic("not supported")
}

func (db *Database) NewBatchWithSize(size int) lkeadb.Batch {
	panic("not supported")
}

func (db *Database) NewIterator(prefix []byte, start []byte) lkeadb.Iterator {
	panic("not supported")
}
...
func (db *Database) NewSnapshot() (lkeadb.Snapshot, error) {
	panic("not supported")
}
...
func New(endpoint string) (lkeadb.Database, error) {
