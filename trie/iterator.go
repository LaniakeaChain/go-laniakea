...
type NodeIterator interface {
	...
	AddResolver(lkeadb.KeyValueReader)
}
...
type nodeIterator struct {
	...
	resolver lkeadb.KeyValueReader // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver lkeadb.KeyValueReader) {
...
func (it *differenceIterator) AddResolver(resolver lkeadb.KeyValueReader) {
...
func (it *unionIterator) AddResolver(resolver lkeadb.KeyValueReader) {
	panic("not implemented")
}
