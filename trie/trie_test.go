...
func (s *spongeDb) NewBatch() lkeadb.Batch                    { return &spongeBatch{s} }
func (s *spongeDb) NewBatchWithSize(size int) lkeadb.Batch    { return &spongeBatch{s} }
func (s *spongeDb) NewSnapshot() (lkeadb.Snapshot, error)     { panic("implement me") }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) lkeadb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w lkeadb.KeyValueWriter) error { return nil }
