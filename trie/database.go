...
type Database struct {
	diskdb lkeadb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb lkeadb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb lkeadb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() lkeadb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch lkeadb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
