...
func (ga *GenesisAlloc) flush(db lkeadb.Database) error {
...
func CommitGenesisState(db lkeadb.Database, hash common.Hash) error {
...
func SetupGenesisBlock(db lkeadb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil, nil)
}

func SetupGenesisBlockWithOverride(db lkeadb.Database, genesis *Genesis, overrideTerminalTotalDifficulty *big.Int, overrideTerminalTotalDifficultyPassed *bool) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db lkeadb.Database) (*types.Block, error) {
	block := g.ToBlock()
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db lkeadb.Database) *types.Block {
