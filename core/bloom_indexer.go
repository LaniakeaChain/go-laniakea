...
import (
	...
	"github.com/LaniakeaChain/go-laniakea/common/bitutil"
...
type BloomIndexer struct {
	...
	db      lkeadb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db lkeadb.Database, size, confirms uint64) *ChainIndexer {
