...
func ReadSnapshotDisabled(db lkeadb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db lkeadb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db lkeadb.KeyValueWriter) {
...
func ReadSnapshotRoot(db lkeadb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db lkeadb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db lkeadb.KeyValueWriter) {
...
func ReadAccountSnapshot(db lkeadb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db lkeadb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db lkeadb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db lkeadb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db lkeadb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db lkeadb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db lkeadb.Iteratee, accountHash common.Hash) lkeadb.Iterator {
...
func ReadSnapshotJournal(db lkeadb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db lkeadb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db lkeadb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db lkeadb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db lkeadb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db lkeadb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db lkeadb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db lkeadb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db lkeadb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db lkeadb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db lkeadb.KeyValueWriter, status []byte) {
