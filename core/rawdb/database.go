...
import (
	...
	"github.com/LaniakeaChain/go-laniakea/lkeadb/leveldb"
	"github.com/LaniakeaChain/go-laniakea/lkeadb/memorydb"
...
func (db *nofreezedb) ModifyAncients(func(lkeadb.AncientWriteOp) error) (int64, error) {
	return 0, errNotSupported
}
...
func (db *nofreezedb) ReadAncients(fn func(reader lkeadb.AncientReaderOp) error) (err error) {
...
func NewDatabase(db lkeadb.KeyValueStore) lkeadb.Database {
...
func NewDatabaseWithFreezer(db lkeadb.KeyValueStore, ancient string, namespace string, readonly bool) (lkeadb.Database, error) {
...
func NewMemoryDatabase() lkeadb.Database {
...
func NewMemoryDatabaseWithCap(size int) lkeadb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (lkeadb.Database, error) {
...
// opened.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, ancient string, namespace string, readonly bool) (lkeadb.Database, error) {
...
func InspectDatabase(db lkeadb.Database, keyPrefix, keyStart []byte) error {
