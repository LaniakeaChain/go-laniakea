...
func NewTable(db lkeadb.Database, prefix string) lkeadb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(lkeadb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader lkeadb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) lkeadb.Iterator {
...
func (t *table) NewBatch() lkeadb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) lkeadb.Batch {
...
func (t *table) NewSnapshot() (lkeadb.Snapshot, error) {
...
func (b *tableBatch) Replay(w lkeadb.KeyValueWriter) error {
