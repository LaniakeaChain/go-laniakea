...
func NewHeaderChain(chainDb lkeadb.Database, config *params.ChainConfig, engine consensus.Engine, procInterrupt func() bool) (*HeaderChain, error) {
...
type (
	...
	UpdateHeadBlocksCallback func(lkeadb.KeyValueWriter, *types.Header) (uint64, bool)

	// DeleteBlockContentCallback is a callback function that is called by SetHead
	// before each header is deleted.
	DeleteBlockContentCallback func(lkeadb.KeyValueWriter, common.Hash, uint64)
)
