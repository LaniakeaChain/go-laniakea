...
func NewPruner(db lkeadb.Database, datadir, trieCachePath string, bloomSize uint64) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb lkeadb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db lkeadb.Database, trieCachePath string) error {
...
func extractGenesis(db lkeadb.Database, stateBloom *stateBloom) error {
