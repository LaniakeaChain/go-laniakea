...
// account array.
func checkStateAccounts(t *testing.T, db lkeadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db lkeadb.Database, root common.Hash) error {
...
func checkStateConsistency(db lkeadb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(lkeadb.Database), srcRoot)
