...
func loadAndParseJournal(db lkeadb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb lkeadb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, recovery bool) (snapshot, bool, error) {
...
func iterateJournal(db lkeadb.KeyValueReader, callback journalCallback) error {
