...
//
// Detailed usage document and tutorial available on the go-laniakea Wiki page:
// https://github.com/LaniakeaChain/go-laniakea/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
