...
import (
	...
	"github.com/LaniakeaChain/go-laniakea/p2p/enode"
	"github.com/LaniakeaChain/go-laniakea/p2p/enr"
...
func NewNodeStateMachine(db lkeadb.KeyValueStore, dbKey []byte, clock mclock.Clock, setup *Setup) *NodeStateMachine {
	if setup.flags == nil {
