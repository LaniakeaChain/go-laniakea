...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db lkeadb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db lkeadb.Database) error {
